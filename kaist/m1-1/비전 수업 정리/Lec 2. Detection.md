...
RoI Pooling => box의 4 꼭지점을 일단 pixel 단위에 맞게 변경, 이후 RoI (Region of interest)에 대해 pooling(적당히 잘라 넣는, 크기 맞춰야 하니깐)
...
RPN (Region Proposal Network): 각 격자 셀마다 ancho box를 설정하여, clssification 2개, regression 4개 총 6개의 task를 통해 box를 설정하고, fast R-CNN적용
![[Pasted image 20260418015140.png|400]]

**FPN (Feature Pyramid Network)**
![[Pasted image 20260418022311.png|400]]


**YOLO**
![[Pasted image 20260418023358.png|400]]
B: box 수, C: 예측할 Class 수
이미지에 일정 격자를 만들고, box와 class를 설정하여 detect

![[Pasted image 20260418023658.png|400]]
